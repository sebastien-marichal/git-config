...
The `git clr`, `git frm`, and `git sc` aliases call helper scripts from `PATH`. Add this repository's `bin` directory to your shell startup file so script changes are used directly from the checkout.
